(defproject pjmusic "0.1.0-SNAPSHOT"

  :description "Peter's Music"
                   ...
                   :cljsbuild      {:builds
                                    {:app
                                     {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                                      :figwheel     {:on-jsload "pjmusic.core/mount-components"}
